...
当前版本：1.5.1（Android versionCode 33）
...
- `dist/coffee-vault-1.5.1-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `1.5.1`（versionCode `33`），最低 Android 7/API 24，目标 Android 16/API 36。
