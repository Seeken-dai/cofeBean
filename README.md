...
当前版本：1.4.6（Android versionCode 29）
...
- `dist/coffee-vault-1.4.6-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `1.4.6`（versionCode `29`），最低 Android 7/API 24，目标 Android 16/API 36。
