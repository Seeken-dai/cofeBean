...
当前版本：2.1.0（Android versionCode 43）
...
- `dist/coffee-vault-2.1.0-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `2.1.0`（versionCode `43`），最低 Android 7/API 24，目标 Android 16/API 36。
