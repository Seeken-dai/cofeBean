...
当前版本：2.0.4（Android versionCode 37）
...
- `dist/coffee-vault-2.0.4-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `2.0.4`（versionCode `37`），最低 Android 7/API 24，目标 Android 16/API 36。
