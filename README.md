...
当前版本：2.1.1（Android versionCode 44）
...
- `dist/coffee-vault-2.1.1-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `2.1.1`（versionCode `44`），最低 Android 7/API 24，目标 Android 16/API 36。
