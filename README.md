...
当前版本：2.0.9（Android versionCode 42）
...
- `dist/coffee-vault-2.0.9-release.apk`
...
当前包信息：`com.coffeebean.vault`，版本 `2.0.9`（versionCode `42`），最低 Android 7/API 24，目标 Android 16/API 36。
