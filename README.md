...
当前版本：1.4.5（Android versionCode 28）
...
- `dist/coffee-vault-1.4.5-release.apk`
...
- 个人中心提供咖啡日历入口，支持月历详情、连续年历格子图、当天花费与评分浮层；数据备份入口统一管理导出与恢复
...
当前包信息：`com.coffeebean.vault`，版本 `1.4.5`（versionCode `28`），最低 Android 7/API 24，目标 Android 16/API 36。
