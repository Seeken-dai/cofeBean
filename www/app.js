(function () {
  ...
  const FIELD_LABELS = { name: '豆名', roaster: '烘焙商', origin: '产地', process: '处理法', roastLevel: '烘焙度', roastDate: '烘焙日期', openedDate: '开封日期', bestFlavorDays: '最佳赏味期', initialWeight: '初始克重', remainingWeight: '剩余克重', tastingNotes: '风味笔记' };
