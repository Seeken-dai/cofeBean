(function () {
  ...
  const { openDrinkBrewAssist, openPlanBrewAssist, pauseBrewAssist, tapBrewAssistRing, skipBrewAssistStage, finishBrewAssist, cancelBrewAssist, requestWakeLock } =
    window.AppBrewAssist.create({ $, $$, state, els, core: BeanCore, toast, setDialog, esc, formatWeight, durationText, setDurationControl, syncRatioValue, syncDurationField, currentDrinkMethod, selectedDrinkPlan, drinkParamSnapshot, openPlanDetail });
  ...
  const { exportBackup, startImport, webImport, offerMigration, migrateLegacy } =
